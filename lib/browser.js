...
/* Chrome */
    ...
    browser = {
         ...
         */
        zeeguuEncodeUrl: function(term, url, context) {
            ...
            encoded = chrome.extension.getURL("gui/html/ext_dict.html") + '?' +
                encodeURIComponent(term.replace(/\ /g, "+") + " " + url + " " + context);
            return encoded;
        },
        zeeguuDecodeURL: function(url) {
            ...
            message.context = query.substr(second_space_pos + 1);
            return message;
        },
