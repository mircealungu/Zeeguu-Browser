...
/* Chrome */
    ...
    browser = {
        ...
        zeeguuUrl: function(term, url, context) {
            // this truly is an amazing language. if you leave a space after return
            // and then add another expression after it will return None
            return chrome.extension.getURL("gui/html/search_results.html") + '?' +
                encodeURIComponent(term.replace(" ", "+") + " " + url + " " + context);
        },
